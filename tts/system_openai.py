...
def llm_update_config(user_request: str, config: dict) -> dict:
    ...
    messages = [
        ...
        If the request is not related to voice style or speaking style, do not change anything and return the current configuration as is.
